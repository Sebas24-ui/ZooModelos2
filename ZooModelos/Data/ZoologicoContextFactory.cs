...
namespace ZooModelos2.Data
{
    public class ZoologicoContextFactory
    {
        public ZooModelosContext CreateDbContext(string[] args)
        {
            ...
            var builder = new DbContextOptionsBuilder<ZooModelosContext>();
            ...
            return new ZooModelosContext(builder.Options);
        }
    }
}
